...
CATASTROPHIC_EVENT_IDS = {"8", "10", "13", "24"}
...
GAME_EVENTS = [
    ...
    # ── EVENTO 7 — Ciclo di Apprendimento ───────────────────────
    # STF: La Quarta Scienza / Ciclo ipotesi-test-valida
    {
        ...
        "propagation": "sistemica",
        "impacts": _fill({
            # AI Drug Discovery: +++ (TEM/Tempus AI è protagonista)
    ...
    # ── EVENTO 11 — Il Muro dell'Energia ─────────────────────────
    ...
    # ── EVENTO 14 — Dark Factory Mandate ─────────────────────────
    ...
    # ── EVENTO 17 — TumorScan AI ──────────────────────────────────
    {
        "event_id": "17",
        "title": "AI diagnostica 14 tumori da un singolo prelievo di sangue con 99.1% di accuratezza",
        "body": (
            "Grail (controllata Illumina) presenta il test Galleri 2.0: un singolo prelievo di sangue, "
            "processato da un modello AI multi-omico, rileva 14 tipi di tumore con 99.1% di accuratezza "
            "e 0.3% di falsi positivi. Medicare e il NHS britannico lo inseriscono nelle coperture standard. "
            "Il mercato della diagnostica oncologica viene rivoluzionato: le aziende di AI applicata alla "
            "scoperta farmaci vedono un boom di interesse, ma le aziende di dispositivi chirurgici perdono "
            "terreno — se i tumori si trovano prima, servono meno interventi complessi."
        ),
        "category": "tech_disruption",
        "tone": "ambiguo",
        "scope": "ibrido",
        ...
        "duration_class": "C",
        "decay_pattern": "Compounding",
        "propagation": "indiretta",
        "impacts": _fill({
            "ILMN": +10.0, "RXRX": +8.0, "SDGR": +7.0, "GOOGL": +6.0,
            "BNTX": +5.0, "MRNA": +4.0, "VRTX": +3.0, "CRSP": +2.0,
            "AZN": +4.0, "UNH": +6.0, "LLY": +3.0,
            "MDT": -5.0, "ISRG": -6.0,
            "NVDA": +3.0, "AVGO": +2.0,
            "CEG": +2.0, "VST": +1.0,
            "ABB": -1.0, "TER": -1.0,
        ...
        "persistence_filter": {},
        "variable_updates": {
            "ricavi_attesi": +10, "momentum_percepito": +12,
            "domanda_finale": +8, "visibilita_utili": +6,
        },
    },

    # ── EVENTO 18 — AlphaFold4 ────────────────────────────────────
    {
        "event_id": "18",
        "title": "DeepMind risolve la struttura di ogni proteina conosciuta: drug discovery accelera 100x",
        "body": (
            "DeepMind pubblica AlphaFold 4: il modello predice la struttura 3D di tutte le 200.000+ "
            "proteine conosciute con accuratezza atomica. Ogni laboratorio farmaceutico del mondo puo' "
            "ora progettare farmaci completamente in silico. Big Pharma firma licenze miliardarie con "
            "Google. La domanda di potenza computazionale per simulazione molecolare esplode, trascinando "
            "i semiconduttori e l'energia nucleare (per alimentare i data center). Anche l'agritech "
            "beneficia: le proteine vegetali possono essere ingegnerizzate con precisione atomica."
        ),
        "category": "tech_disruption",
        "tone": "positivo",
        "scope": "trasversale",
        ...
        "propagation": "sistemica",
        "impacts": _fill({
            "RXRX": +11.0, "SDGR": +10.0, "GOOGL": +8.0, "ILMN": +7.0,
            "CRSP": +9.0, "BNTX": +7.0, "MRNA": +6.0, "VRTX": +5.0,
            "LLY": +4.0, "AZN": +3.0, "UNH": +2.0, "MDT": +1.0,
            "NVDA": +5.0, "AVGO": +4.0, "INTC": +2.0, "ASML": +1.0,
            "CEG": +3.0, "VST": +2.0, "OKLO": +1.0,
            "CTVA": +2.0, "DE": +1.0,
        }),
        "persistence": {1: 0.70, 2: 1.00, 3: 0.80, 4: 0.50},
        "persistence_filter": {},
        "variable_updates": {
            "ricavi_attesi": +15, "capex_attesi": +10,
            "momentum_percepito": +14, "domanda_finale": +12,
        },
    },

    # ── EVENTO 19 — DarkFactory Foxconn ───────────────────────────
    {
        "event_id": "19",
        "title": "Foxconn mostra fabbrica 100% AI-robotica: zero operai, output +340%",
        "body": (
            "Foxconn inaugura la prima fabbrica completamente AI-gestita a Shenzhen. Zero operai umani, "
            "340% di output rispetto alla fabbrica tradizionale. ABB e Teradyne forniscono i robot, "
            "NVIDIA i chip AI per la visione artificiale. Goldman Sachs stima che il 30% della manifattura "
            "globale sara' fully automated entro il 2030. Il settore logistico trema: se le fabbriche "
            "producono di piu', i magazzini devono cambiare. L'agricoltura meccanizzata perde attrattiva "
            "rispetto all'automazione industriale."
        ),
        "category": "tech_disruption",
        "tone": "ambiguo",
        "scope": "trasversale",
        ...
        "propagation": "sistemica",
        "impacts": _fill({
            "ABB": +10.0, "TER": +11.0, "ROK": +8.0, "ISRG": +5.0,
            "NVDA": +7.0, "AVGO": +5.0, "ASML": +4.0, "INTC": +3.0,
            "CEG": +3.0, "VST": +2.0,
            "AMZN": +3.0, "MDT": +2.0, "UNH": +1.0,
            "UPS": -5.0, "FDX": -6.0, "XPO": -4.0,
            "DE": -3.0, "AGCO": -2.0, "CTVA": -1.0,
        }),
        "persistence": {1: 0.70, 2: 1.00, 3: 0.80, 4: 0.50},
        "persistence_filter": {},
        "variable_updates": {
            "ricavi_attesi": +8, "costi_operativi": -12,
            "momentum_percepito": +15, "rischio_supply_chain": -8,
        },
        "cascade_impacts": {
            1: {"UPS": -3.0, "FDX": -4.0, "DE": -2.0, "AGCO": -2.0, "ADM": -1.0},
            2: {"ABB": +4.0, "TER": +3.0, "NVDA": +3.0, "AMZN": +2.0},
        },
    },

    # ── EVENTO 20 — ToxicMolecule ─────────────────────────────────
    {
        "event_id": "20",
        "title": "AI genera molecola tossica non prevista: 3 pazienti in terapia intensiva",
        "body": (
            "Un farmaco progettato interamente dall'AI di Recursion Pharmaceuticals causa insufficienza "
            "epatica acuta in 3 pazienti durante un trial di Fase 2. La FDA emette un blocco immediato "
            "su tutti i farmaci AI-designed in fase di revisione. La comunita' scientifica si divide: i "
            "sostenitori parlano di errore isolato, i critici chiedono un moratorio di 2 anni. I titoli "
            "di AI drug discovery crollano, ma la farmaceutica tradizionale e i dispositivi medici "
            "rimbalzano — i metodi classici tornano di moda."
        ),
        "category": "cigno_nero",
        "tone": "negativo",
        "scope": "ibrido",
        ...
        "propagation": "diretta",
        "impacts": _fill({
            "RXRX": -13.0, "SDGR": -11.0, "GOOGL": -8.0, "ILMN": -6.0,
            "CRSP": -5.0, "BNTX": -4.0, "MRNA": -5.0, "VRTX": -3.0,
            "NVDA": -3.0, "AVGO": -2.0, "INTC": -1.0,
            "UNH": +5.0, "LLY": +6.0, "MDT": +5.0, "AZN": +4.0,
            "ISRG": +4.0, "ABB": +1.0, "TER": +1.0,
        }),
        "persistence": {1: 0.50, 2: 0.20},
        "persistence_filter": {},
        "variable_updates": {
            "rischio_regolatorio": +15, "visibilita_utili": -12,
            "momentum_percepito": -15, "fragilita_strategica": +10,
        },
    },

    # ── EVENTO 21 — SuperConductor AI ─────────────────────────────
    {
        "event_id": "21",
        "title": "AI scopre superconduttore a temperatura ambiente: confermato da 3 laboratori europei",
        "body": (
            "Un modello AI del Max Planck Institute scopre un composto superconduttore stabile a 22 gradi "
            "Celsius. CERN, ETH Zurigo e Oxford confermano indipendentemente la scoperta. Se il materiale "
            "sara' producibile industrialmente, rivoluzionera' l'energia (trasmissione senza perdite), il "
            "computing (chip superconduttivi a temperatura ambiente) e i trasporti (levitazione magnetica "
            "commerciale). I semiconduttori esplodono, ma il nucleare crolla: se l'energia si trasmette "
            "senza perdite, servono meno centrali."
        ),
        "category": "tech_disruption",
        "tone": "ambiguo",
        "scope": "trasversale",
        ...
        "propagation": "sistemica",
        "impacts": _fill({
            "NVDA": +10.0, "INTC": +9.0, "AVGO": +8.0, "ASML": +7.0,
            "ABB": +6.0, "TER": +5.0, "ROK": +3.0, "ISRG": +3.0,
            "MDT": +4.0, "AZN": +2.0,
            "AMZN": +3.0, "XPO": +2.0, "UPS": +2.0, "FDX": +1.0,
            "OKLO": -8.0, "CEG": -7.0, "VST": -6.0, "CCJ": -9.0,
        }),
        "persistence": {1: 0.80, 2: 1.00, 3: 0.60},
        "persistence_filter": {},
        "variable_updates": {
            "capex_attesi": +12, "ricavi_attesi": +8,
            "momentum_percepito": +18, "costi_operativi": -10,
            "rischio_supply_chain": -5,
        },
    },

    # ── EVENTO 22 — AutonomousTrucks ──────────────────────────────
    {
        "event_id": "22",
        "title": "Flotta di 2.000 camion autonomi opera coast-to-coast senza intervento umano",
        "body": (
            "Aurora Innovation lancia la prima flotta commerciale di 2.000 TIR completamente autonomi "
            "sulle interstate USA. Amazon, Walmart e FedEx firmano contratti quinquennali. I camion operano "
            "coast-to-coast senza intervento umano, con un costo per miglio inferiore del 62%. Il sindacato "
            "dei camionisti annuncia lo sciopero generale. Le aziende di logistica tradizionale vacillano, "
            "ma chi adotta la tecnologia prospera. I semiconduttori salgono per la domanda di chip AI di "
            "guida, e l'energia nucleare beneficia della domanda elettrica della flotta."
        ),
        "category": "tech_disruption",
        "tone": "ambiguo",
        "scope": "ibrido",
        ...
        "impacts": _fill({
            "AMZN": +8.0, "XPO": +6.0,
            "UPS": -7.0, "FDX": -8.0,
            "NVDA": +6.0, "AVGO": +3.0, "INTC": +2.0,
            "TER": +4.0, "ROK": +3.0, "ABB": +2.0,
            "CEG": +3.0, "VST": +2.0, "OKLO": +2.0,
            "DE": +3.0, "AGCO": +2.0,
            "UNH": -2.0, "MDT": -1.0,
        }),
        "persistence": {1: 0.70, 2: 1.00, 3: 0.80, 4: 0.50},
        "persistence_filter": {},
        "variable_updates": {
            "costi_operativi": -15, "ricavi_attesi": +6,
            "rischio_supply_chain": -10, "momentum_percepito": +12,
        },
    },

    # ── EVENTO 23 — ChipDesign AI ─────────────────────────────────
    {
        "event_id": "23",
        "title": "AI progetta chip a 2nm senza ingegneri: ASML conferma il design fabbricabile",
        "body": (
            "OpenAI dimostra che GPT-6 progetta un chip a 2nm funzionante in 48 ore: dalla specifica "
            "al layout fisico. Normalmente servono 200 ingegneri e 18 mesi. ASML conferma che il design "
            "e' fabbricabile. Il vantaggio competitivo ingegneristico di NVIDIA evapora — chiunque puo' "
            "progettare chip custom. Ma le fonderie (ASML, Intel) esplodono perche' la domanda di "
            "produzione si moltiplica. La robotica beneficia di chip su misura per ogni applicazione. "
            "L'AI drug discovery ottiene chip ottimizzati per simulazione molecolare."
        ),
        "category": "tech_disruption",
        "tone": "ambiguo",
        "scope": "trasversale",
        ...
        "impacts": _fill({
            "ASML": +9.0, "INTC": +7.0,
            "NVDA": -8.0, "AVGO": -4.0,
            "TER": +6.0, "ABB": +5.0, "ROK": +4.0, "ISRG": +3.0,
            "RXRX": +5.0, "SDGR": +4.0, "GOOGL": +3.0, "ILMN": +2.0,
            "CEG": +3.0, "VST": +2.0,
            "UPS": -2.0, "FDX": -2.0, "XPO": -1.0,
        }),
        "persistence": {1: 0.70, 2: 1.00, 3: 0.80, 4: 0.50},
        "persistence_filter": {},
        "variable_updates": {
            "capex_attesi": -8, "margini_attesi": +6,
            "momentum_percepito": +10, "costi_operativi": -6,
            "fragilita_strategica": +5,
        },
        "cascade_impacts": {
            1: {"NVDA": -5.0, "AVGO": -3.0, "TER": +3.0, "ABB": +2.0},
            2: {"INTC": +4.0, "ASML": +3.0, "RXRX": +3.0, "SDGR": +2.0},
        },
    },

    # ── EVENTO 24 — AGI Emergence ─────────────────────────────────
    {
        "event_id": "24",
        "title": "AGI emergente in laboratorio Google: il modello supera tutti i benchmark umani",
        "body": (
            "Google DeepMind annuncia che Gemini Ultra 3 ha superato ogni benchmark cognitivo umano "
            "conosciuto, incluso ragionamento scientifico a livello Nobel, creativita' artistica e "
            "pianificazione strategica a lungo termine. Il CEO di Google chiede una pausa normativa "
            "immediata. I mercati entrano in panico: i governi si riuniscono in sessione d'emergenza. "
            "L'AGI promette di accelerare la ricerca scientifica (biotech, drug discovery, robotica), "
            "ma la paura di uno shutdown forzato dei data center colpisce l'energia e la logistica."
        ),
        "category": "cigno_nero",
        "tone": "ambiguo",
        "scope": "trasversale",
        ...
        "propagation": "sistemica",
        "impacts": _fill({
            "NVDA": +6.0, "AVGO": +3.0, "INTC": +2.0, "ASML": +3.0,
            "RXRX": +7.0, "SDGR": +6.0, "GOOGL": +5.0, "ILMN": +4.0,
            "BNTX": +4.0, "MRNA": +3.0, "CRSP": +5.0, "VRTX": +2.0,
            "ISRG": +5.0, "ABB": +4.0, "TER": +3.0, "ROK": +2.0,
            "UNH": +3.0, "LLY": +4.0, "AZN": +2.0, "MDT": +2.0,
            "CEG": -5.0, "VST": -4.0, "OKLO": -6.0, "CCJ": -4.0,
            "UPS": -5.0, "FDX": -5.0, "AMZN": -4.0, "XPO": -3.0,
            "DE": -2.0, "CTVA": -1.0, "ADM": -1.0, "AGCO": -1.0,
        }),
        "persistence": {1: 0.80, 2: 1.00, 3: 0.80, 4: 0.40},
        "persistence_filter": {},
        "variable_updates": {
            "volatilita_attesa": +25, "momentum_percepito": +20,
            "rischio_regolatorio": +15, "fragilita_strategica": +12,
            "visibilita_utili": -10, "domanda_finale": +8,
        },
        "cascade_impacts": {
            1: {"CEG": -4.0, "VST": -3.0, "OKLO": -5.0, "UPS": -3.0, "FDX": -3.0},
            2: {"RXRX": +5.0, "SDGR": +4.0, "ISRG": +3.0, "ABB": +3.0, "NVDA": +4.0},
        },
    },
